...
const store = new Vuex.Store({
  ...
  mutations:{
    setEditData(state,context){
      state.editData=context
    },
    ...
    setUserTouxiang(state,touxiang){
      state.user.touxiang=touxiang
    }
  },
  modules:{
